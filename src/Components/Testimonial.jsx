    ...
    return (
        <div className="bg-neutral-900">
            <section className="relative py-14">
                        ...
                        <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {
                                testimonials.map((item, idx) => (
                                    <li key={idx} className="border shadow-md border-neutral-800 bg-gradient-to-bl from-neutral-800 via-neutral-900 to-neutral-950 rounded-xl">
                                        <div className="p-4">
                                            <svg className="text-green w-9 h-9" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <figure>
                                            <blockquote>
                                                <p className="px-4 py-1 text-lg font-semibold text-neutral-400">
                                                    {item.quote}
                                                </p>
                                            </blockquote>
                                            <div className="flex items-center p-4 mt-6 gap-x-4 bg-neutral-900">
                                                <img src={item.avatar} className="w-16 h-16 border-2 border-green rounded-full" />
                                                <div>
                                                    <span className="block font-semibold text-neutral-400">{item.name}</span>
                                                    <span className="block text-lime-600 text-sm mt-0.5">{item.title}</span>
                                                </div>
                                            </div>
                                        </figure>
                                    </li>
                ...
                <div className="absolute top-0 w-full h-[350px] bg-neutral-900" ></div>
            </section>
        </div>
    )
}
