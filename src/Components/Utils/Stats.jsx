...
const Stats = () => {
    return (
        <div className="bg-neutral-900">
            <div className="max-w-5xl px-4 py-5 mx-auto xl:px-0">
                <div className="border border-neutral-800 rounded-xl">
                    <div className="p-4 lg:p-8 bg-gradient-to-bl from-neutral-800 via-neutral-900 to-neutral-950 rounded-xl">
                        <div className="grid items-center grid-cols-1 sm:grid-cols-3 gap-y-20 gap-x-12">
                            {/* Stat 1 */}
                            <div className="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                                <svg
                                    className="flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 text-green mx-auto"
                                ...
                                <div className="mt-3 sm:mt-5">
                                    <h3 className="text-lg font-semibold text-white sm:text-3xl">2,000+</h3>
                                    <p className="mt-1 text-sm sm:text-base text-neutral-400">Successful Design Projects</p>
                                </div>
                            </div>
                            ...
                            <div className="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                                <div className="flex items-center justify-center -space-x-5">
                                    <img
                                        className="relative z-[2] flex-shrink-0 w-8 h-8 rounded-full border-[3px] border-neutral-800"
                                    ...
                                    />
                                    <img
                                        className="relative z-[1] flex-shrink-0 w-8 h-8 rounded-full border-[3px] border-neutral-800 -mt-7"
                                    ...
                                    />
                                    <img
                                        className="relative flex-shrink-0 w-8 h-8 rounded-full border-[3px] border-neutral-800"
                                ...
                                <div className="mt-3 sm:mt-5">
                                    <h3 className="text-lg font-semibold text-white sm:text-3xl">95%</h3>
